...
add wave -noupdate -radix decimal {/mymips_min_sopc_tb/mymips_min_sopc0/mymips0/regfile1/regs[1]}
add wave -noupdate -radix decimal {/mymips_min_sopc_tb/mymips_min_sopc0/mymips0/regfile1/regs[2]}
add wave -noupdate -radix decimal {/mymips_min_sopc_tb/mymips_min_sopc0/mymips0/regfile1/regs[3]}
add wave -noupdate -radix decimal {/mymips_min_sopc_tb/mymips_min_sopc0/mymips0/regfile1/regs[4]}
add wave -noupdate {/mymips_min_sopc_tb/mymips_min_sopc0/mymips0/regfile1/regs[5]}
